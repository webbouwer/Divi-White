...
/* First part is special extended plugin-install-options */
...
/* Some basics */
require_once('customizer.php'); // customizer functions ( get_stylesheet_directory() . '/')


/* Old menu image option */
...
function dw_theme_settings(){
    ...
    add_settings_field( 'dw_enable_linkmanager', 'Return of the Linkmanager','dw_section_linkmanager_callback', 'dw-theme-panel','dw_first_section' );//add settings field to the
