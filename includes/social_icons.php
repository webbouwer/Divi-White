...
<?php /* new Codeshare icon */
    if ( 'on' === et_get_option( 'divi_show_codeshare_icon', 'on' ) ) : ?>
	<li class="et-social-icon et-social-codeshare">
		<a href="<?php echo esc_url( et_get_option( 'divi_codeshare_url', '#' ) ); ?>" class="icon">
			<span><?php esc_html_e( 'Codeshare', 'Divi' ); ?></span>
		</a>
	</li>
<?php endif; ?>

<?php /* new JS Bin icon */
    if ( 'on' === et_get_option( 'divi_show_jsbin_icon', 'on' ) ) : ?>
	<li class="et-social-icon et-social-jsbin">
		<a href="<?php echo esc_url( et_get_option( 'divi_jsbin_url', '#' ) ); ?>" class="icon">
			<span><?php esc_html_e( 'JS Bin', 'Divi' ); ?></span>
		</a>
	</li>
<?php endif; ?>
